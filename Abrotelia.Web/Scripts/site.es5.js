...
(function ($) {
    ...
    var initGallerySearch = function initGallerySearch(search) {
        ...
        subscribeToNews = function subscribeToNews(email, result) {
        ...
        displayGoogleMap = function displayGoogleMap() {
        var maxHeight = Math.min(450, document.body.clientHeight);
        var maxWidth = Math.min(600, document.body.clientWidth - 30);
        document.documentElement.innerHTML = document.documentElement.innerHTML.replace('[@@ZEMLJEVID@@]', '<iframe width="' + maxWidth + '" height="' + maxHeight + '" frameborder="0" style="border:0;" ' + 'src="https://www.google.com/maps/embed/v1/place?q=koprska%20ulica%2094&key=AIzaSyD9iV1cZ2r3GE7RZf0b5TuQNO-_pJBsohA" allowfullscreen></iframe>');
    };
